...
tcpclient.RemoteHost = "sys-PC" 'tcpclient.LocalHostName
tcpclient.Connect
Label1.Caption = "connecting" & tcpclient.RemoteHost
Text1.Enabled = 0
...
tcpclient.GetData filename, vbString
arrival = True
Open App.Path & "\" & filename For Binary As #1
tcpclient.SendData arrival
Else
tcpclient.GetData filedata(), vbByte
Put #1, , filedata()
tcpclient.SendData arrival
End If
